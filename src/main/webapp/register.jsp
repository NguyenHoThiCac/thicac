            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="register-title">
                        <h3 class="mb-10">ĐĂNG KÝ TÀI KHOÀN</h3>
                    ...
                    <form class="form-register" action="SignUp" method="post">
                        <fieldset>
                            ...
                            <div class="form-group d-md-flex align-items-md-center">
                                ...
                                <div class="col-md-10">
                                    <input name="name" type="text" class="form-control" id="l-name" placeholder="Tên .........">
                                </div>
                            </div>
                            ...
                            <div class="form-group d-md-flex align-items-md-center">
                                ...
                                <div class="col-md-10">
                                    <input name="mail" type="email" class="form-control" id="email" placeholder="Nhập địa chỉ email của bạn vào đây ...">
                                </div>
                            </div>
                            <div class="form-group d-md-flex align-items-md-center">
                                <label class="control-label col-md-2" for="number"><span class="require">*</span>Số điện thoại</label>
                                <div class="col-md-10">
                                    <input name="phone" type="number" class="form-control" id="number" placeholder="Số điện thoại">
                                </div>
                            </div>
                        </fieldset>
                        <fieldset>
                            ...
                            <legend>Mật khẩu của <bạn></bạn></legend>
                            <div class="form-group d-md-flex align-items-md-center">
                            ...
                            <div class="form-group d-md-flex align-items-md-center">
                                ...
                                <div class="col-md-10">
                                    <input name="re_pwd" type="password" class="form-control" id="pwd-confirm" placeholder="Confirm password">
                                </div>
                        ...
                        <fieldset class="newsletter-input">
                            ...
                            <div class="form-group d-md-flex align-items-md-center">
                                <label class="col-md-2 control-label">Đăng kí</label>
                        ...
                        <div class="terms">
                            <div class="float-md-right">
                                <span>Tôi đã đọc và đồng ý với <a href="#" class="agree"><b>Chính sách bảo mật</b></a></span>
