...
<div class="wrapper">
    ...
    <div class="register-account ptb-100 ptb-sm-60">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <form class="form-register" action="ChangePass" method="post">
                        <fieldset>
                            <legend>Thông tin cá nhân của bạn</legend>
                            <p class="text-danger text-center">${messCPass}</p>
                            <div class="form-group d-md-flex align-items-md-center">
                                <label class="control-label col-md-2" for="f-name"><span class="require">*</span>Tên Đăng Nhập</label>
                                <div class="col-md-10">
                                    <input name="username" type="text" class="form-control" id="f-name" placeholder="Tên đăng nhập..........">
                                </div>
                            </div>
                            <p class="text-danger text-center">${messCPass1}</p>
                            <div class="form-group d-md-flex align-items-md-center">
                                <label class="control-label col-md-2" for="pwd"><span class="require">*</span>Mật khẩu hiện tại</label>
                                <div class="col-md-10">
                                    <input name="pwd" type="password" class="form-control" id="pwd" placeholder="Password">
                                </div>
                            </div>
                            <p class="text-danger text-center">${messCPass2}</p>
                            <div class="form-group d-md-flex align-items-md-center">
                                <label class="control-label col-md-2" for="pwd"><span class="require">*</span>Mật khẩu mới:</label>
                                <div class="col-md-10">
                                    <input name="new_pwd" type="password" class="form-control" placeholder="Password">
                                </div>
                            </div>
                            <p class="text-danger text-center">${messCPass3}</p>
                            <div class="form-group d-md-flex align-items-md-center">
                                <label class="control-label col-md-2" for="pwd-confirm"><span class="require">*</span>Nhập lại mật khẩu mới</label>
                                <div class="col-md-10">
                                    <input name="re_newpwd" type="password" class="form-control" id="pwd-confirm" placeholder="Confirm password">
                                </div>
                            </div>
                        </fieldset>
